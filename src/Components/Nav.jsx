    ...
    <div className="pt-6">
      <nav>
        <div className="flex items-center justify-between">
          <div className="bg-[#F9F9F9] border-[1px] border-[#E8E8EA] flex w-full items-center py-4 px-4 rounded-xl max-w-[280px] justify-between">
            <span>
              <svg
            ...
            <input
              className="font-Inter font-normal text-sm text-[#A5A3A9] outline-none bg-transparent"
              type="text"
              placeholder="Search..."
            />
            <span>
          ...
          <div className="flex items-center gap-14">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-zinc-500 text-xs font-semibold font-['Libre Franklin'] tracking-tight">kenzi.lawson@example.com</p>
                </div>
                <span><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 11.5L7.5 4.5L14 11.5" stroke="#E8E8EA" stroke-linecap="square"/></svg></span>
            </div>
          </div>
        </div>
      </nav>
