...
const MetroverseCard = () => {
  ...
  return (
    <div className="bg-white bg-[url(./assets/images/metroSecBg.png)] bg-no-repeat bg-cover rounded-lg sm:rounded-[18px] shadow mt-9">
      <div className="px-3 sm:px-5 md:px-8 lg:px-12 py-2 sm:py-4 md:py-6">
      <div className="flex justify-end gap-6 mb-[-12px] sm:mb-[-30px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center mt-5">
            ...
            <div className="max-w-[283px] text-[#7C7C7C] text-xs font-medium font-Inter mt-3 sm:mt-6 lg:mt-[30px]">
              physical claim for issue #1 now live. please check that the token
              is available for claim via website
            </div>
            <div className="max-w-[140px] mt-3 sm:mt-6 lg:mt-[30px]">
