...
const SideBar = () => {
  return (
    <div className="container p-0 max-w-[100px] sm:max-w-[200px]  lg:max-w-[300px] bg-[#FFFDFF]">
      <div className="fixed bg-[url(./assets/images/sideBarbg.png)] w-full max-w-[50px] xs:max-w-[100px] sm:max-w-[200px]  lg:max-w-[300px] bg-no-repeat bg-top py-4 px-2 sm:py-8 sm:px-6 ">
        <div className=" flex flex-col items-center">
            <img src={logo} alt="" />
          <p className="font-Inter text-base font-bold text-gold-gradient mt-5 max-sm:hidden">URBAN NFT</p>
        </div>
        <div className="mt-16">
          <p className="text-Black text-xs font-medium font-Inter sm:pl-4 max-sm:hidden">MARKETPLACE</p>
          <Link to="/" className="flex gap-4 items-center text-transparent font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-4 bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] w-full">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" > <path opacity="0.4" d="M11.0562 0.5H13.5957C14.6474 0.5 15.4996 1.35939 15.4996 2.41997V4.98089C15.4996 6.04148 14.6474 6.90087 13.5957 6.90087H11.0562C10.0045 6.90087 9.15234 6.04148 9.15234 4.98089V2.41997C9.15234 1.35939 10.0045 0.5 11.0562 0.5Z" fill="url(#paint0_linear_33_463)" /> <path fill-rule="evenodd" clip-rule="evenodd" d="M2.40389 0.5H4.94337C5.99507 0.5 6.84726 1.35939 6.84726 2.41997V4.98089C6.84726 6.04148 5.99507 6.90087 4.94337 6.90087H2.40389C1.35219 6.90087 0.5 6.04148 0.5 4.98089V2.41997C0.5 1.35939 1.35219 0.5 2.40389 0.5ZM2.40389 9.09913H4.94337C5.99507 9.09913 6.84726 9.95852 6.84726 11.0191V13.58C6.84726 14.6399 5.99507 15.5 4.94337 15.5H2.40389C1.35219 15.5 0.5 14.6399 0.5 13.58V11.0191C0.5 9.95852 1.35219 9.09913 2.40389 9.09913ZM13.5961 9.09913H11.0566C10.0049 9.09913 9.15274 9.95852 9.15274 11.0191V13.58C9.15274 14.6399 10.0049 15.5 11.0566 15.5H13.5961C14.6478 15.5 15.5 14.6399 15.5 13.58V11.0191C15.5 9.95852 14.6478 9.09913 13.5961 9.09913Z" fill="url(#paint1_linear_33_463)" /> <defs> <linearGradient id="paint0_linear_33_463" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse" > <stop stop-color="#FFC881" /> <stop offset="1" stop-color="#DA8517" /> </linearGradient> <linearGradient id="paint1_linear_33_463" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse" >
            ...
            <span className="text-gold-gradient max-sm:hidden">Dashboard</span>
          </Link>
          <Link to="/market" className="flex gap-4 items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg
            ...
            <span className=" text-[#7C7C7C]">Market</span>
          </Link>
          <Link to="/Favorites" className="flex gap-4 items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <span className=" text-[#7C7C7C]">Favorites</span>
          </Link>
        </div>
        <div className="mt-16">
          <p className="text-Black text-xs font-medium font-Inter pl-4">
            MY PROFILE
          </p>
          <Link to="/insight" className="flex gap-4 items-center text-transparent font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-4 bg-white w-full">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <span className=" text-[#7C7C7C]">Insight</span>
          </Link>
          <button className="flex gap-4 items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <button className="flex gap-4 items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            ...
            <span className=" text-[#7C7C7C]">Profile</span>
          </button>
          <button className="flex gap-4 items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg
            ...
            <span className=" text-[#7C7C7C]">Setting</span>
          </button>
        </div>
      </div>
    </div>
