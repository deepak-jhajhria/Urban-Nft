  ...
  return (
    <div className="container p-0 min-w-[50px] max-w-[50px] xs:max-w-[100px] sm:max-w-[200px]  lg:max-w-[305px] bg-[#FFFDFF] h-full">
      <div className="fixed top-0 bottom-0 bg-[url(./assets/images/sideBarbg.png)] w-full max-w-[50px] xs:max-w-[100px] sm:max-w-[200px]  lg:max-w-[305px] bg-no-repeat bg-top py-4 px-2 lg:py-8 lg:px-6 flex flex-col justify-between min-h-screen">
        ...
        <div className="overflow-y-scroll scrollbar-hide h-full flex flex-col justify-between">
          <div>
              ...
              <Link to="/market" className={commonLink}>
                <span>
                  <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_464)]' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_33_464" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_33_464" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                    </defs>
                ...
                <span>
                  <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_465)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <defs>
                      ...
                      <linearGradient id="paint1_linear_33_465" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                    </defs>
            ...
            <div className="mt-10 md:mt-16 lg:mt-[90px] xl:mt-[130px] sm:px-2">
              ...
              <Link to="/insight" className={commonLinkTwo}>
                <span>
                  <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_466)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_33_466" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_33_466" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                    </defs>
              ...
              <Link to="/wallet" className={commonLink}>
                <span>
                  <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_467)]' xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none">
                    ...
                    <path opacity="0.4" d="M11.0281 7.22231C11.1849 7.93569 11.8104 8.43761 12.5244 8.42456H14.9619C15.259 8.42456 15.5 8.17849 15.5 7.87434V5.97567C15.4994 5.67217 15.259 5.42546 14.9619 5.4248H12.4671C11.6548 5.42742 10.9987 6.10164 11 6.93251C11 7.02976 11.0096 7.12701 11.0281 7.22231Z" fill="#A8A8A8" />
                    <circle cx="12.5" cy="6.9248" r="0.75" />
                    <defs>
                      <linearGradient id="paint0_linear_33_467" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_33_467" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                    </defs>
              ...
              <Link className={commonLink}>
                ...
                <span className="text-[#7C7C7C] group-focus:text-gold-gradient max-sm:hidden">Profile</span>
              </Link>
              {/* setting  */}
              <Link className={commonLink}>
                <span>
                  <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_470)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_33_470" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_33_470" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFC881" />
                        <stop offset="1" stop-color="#DA8517" />
                      </linearGradient>
                    </defs>
