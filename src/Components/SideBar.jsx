...
const SideBar = () => {
  return (
    <div className="container max-w-[300px] py-8 px-6 bg-[#FFFDFF]">
      <div className=" flex flex-col items-center">
        ...
        <p className="font-Inter text-base font-bold text-gold-gradient mt-5">
          URBAN NFT
        </p>
      </div>
      <div className="mt-16">
        ...
        <button className="flex gap-4 items-center text-transparent font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-4 bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] w-full">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
      ...
      <div className="mt-16">
        ...
        <button className="flex gap-4 items-center text-transparent font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-4 bg-white w-full">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
